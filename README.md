# ioss-netp-exclusions-performance-tests

Performance test suite for the `ioss-netp-exclusions-performance-tests`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
